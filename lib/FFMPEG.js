...
const FFMPEG = function (hap, cameraName, startFeedSupplier, stopFeedSupplier, log) {
    this.log = log;
...
FFMPEG.prototype = {
    async getSnapshotSource() {
        return "-i " + await this.getCameraFeed();
    },

    async getVideoSource() {
        return "-rtsp_transport tcp -vcodec h264_mmal -re -i " + await this.getCameraFeed();
    },
    ...
    async getCameraFeed() {
        ...
        let feed = feedSessionInfo.session.streamRtspUrl;
