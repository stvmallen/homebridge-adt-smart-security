...
class ContactSensor {
    ...
    static with(sensorInfo, log, hap, platformAccessory) {
        ...
        return new ContactSensor(sensorInfo.name, sensorInfo.status, log, new platformAccessory(sensorInfo.name, UUIDGen.generate(sensorInfo.name), Accessory.Categories.SENSOR));
    }
