...
class Camera {
    ...
    configureCameraSource() {
        this.platformAccessory.configureCameraSource(new FFMPEG(this.hap, this.cameraName, this.getStartFeedSupplier.bind(this), this.getStopFeedSupplier.bind(this), this.log));
    }
