...
class Camera {
    ...
    configureCameraSource() {
        this.platformAccessory.configureCameraSource(new FFMPEG(this.hap, this.cameraName, this.getStartFeedSupplier, this.getStopFeedSupplier, this.log));
    }

    getStartFeedSupplier() {
        return new Promise(() => {
            this.log.debug('Supplying camera feed');
            return this.adt.startFeed(this.cameraId);
        });
    }
    ...
    getStopFeedSupplier() {
        return new Promise(() => {
            ...
            return this.adt.stopFeed(this.cameraId);
        });
    }
}
